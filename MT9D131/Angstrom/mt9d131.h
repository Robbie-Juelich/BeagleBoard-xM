...
// Jsut check for this enum need
enum {   				
       MT9D131_COLOR_VERSION,
       MT9D131_MONOCHROME_VERSION,
};
...
struct mt9d131_platform_data {
       ...
       int version; /* MT9P031_COLOR_VERSION or MT9P031_MONOCHROME_VERSION */ //Just check for it's need
};
#endif /* __MT9D131_H__ */
