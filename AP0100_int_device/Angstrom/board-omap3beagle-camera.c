...
#if defined(CONFIG_VIDEO_AP0100) || defined(CONFIG_VIDEO_AP0100_MODULE)
#include <media/ap0100.h>

#define ISP_AP0100_MCLK	216000000

/* Arbitrary memory handling limit */
#define AP0100_MAX_FRAME_SIZE	PAGE_ALIGN(1280 * 720 * 4)

static struct isp_interface_config ap0100_if_config = {
...
static struct v4l2_ifparm ap0100_ifparm_s = {
	...
	.u 	 = {
		.ycbcr = {
			...
			.nobt_hs_inv		= 0,
			.nobt_vs_inv		= 0,
			.clock_min		= AP0100_CLK_MIN,
			.clock_max		= AP0100_CLK_MAX,
		},
	},
};

/**
 * @brief ap0100_ifparm - Returns the ap0100 interface parameters
 *
 * @param p - pointer to v4l2_ifparm structure
 *
 * @return result of operation - 0 is success
 */
static int ap0100_ifparm(struct v4l2_ifparm *p)
{
	if (p == NULL)
		return -EINVAL;
...
static struct omap34xxcam_hw_config ap0100_hwc = {
	.dev_index		= 0,
	.dev_minor		= 0,
	.dev_type		= OMAP34XXCAM_SLAVE_SENSOR,
	.u.sensor.sensor_isp	= 1,
	.u.sensor.capture_mem	= AP0100_MAX_FRAME_SIZE * 2,
	.u.sensor.ival_default	= { 1, 10 },
};

/**
 * @brief ap0100_set_prv_data - Returns ap0100 omap34xx driver private data
 *
 * @param priv - pointer to omap34xxcam_hw_config structure
 *
 * @return result of operation - 0 is success
 */
static int ap0100_set_prv_data(void *priv)
{
...
/**
 * @brief ap0100_power_set - Power-on or power-off TVP5146 device
 *
 * @param power - enum, Power on/off, resume/standby
 *
 * @return result of operation - 0 is success
 */
static int ap0100_power_set(struct v4l2_int_device *s, enum v4l2_power power)
{
	...
	case V4L2_POWER_ON:
		...
		isp_configure_interface(vdev->cam->isp, &ap0100_if_config);
		/* Set RESET_BAR to 0 */
...
struct ap0100_platform_data ap0100_pdata = {
	.master		= "omap34xxcam",
	.power_set	= ap0100_power_set,
	.priv_data_set	= ap0100_set_prv_data,
	.ifparm		= ap0100_ifparm,
};

#endif				/* #ifdef CONFIG_VIDEO_AP0100 */
