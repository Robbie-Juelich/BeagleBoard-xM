...
-------------------------------------------------------------------------
|									|
|	Aptina MT9V113 (VGA SOC) image sensor linux driver release	|
|									|
-------------------------------------------------------------------------
    Release notes for the Aptina MT9V113 image sensor linux driver.
...
MT9V113 Driver
--------------
    The MT9V113 driver is a Video for Linux 2 (V4L2) driver that is compiled
...
------------------------
    ...
    - Aptina Beagleboard-XM Adapter/Revision 0 and MT9V113 VGA SOC sensor.


DRIVER SOURCE CODE FILES
------------------------
    Driver files and directory locations are listed below:
    mt9v113.c, Makefile, and Kconfig are located at:
        kernel-3.1.2/drivers/media/video

    mt9v113.h is located at:
...
--------------------------------------
    Copy MT9V113 related files into the kernel directories:
        $cp your_mt9v113_driver_directory/board-omap3beagle.c  ./arch/arm/mach-omap2
        $cp your_mt9v113_driver_directory/board-omap3beagle-camera.c  ./arch/arm/mach-omap2
        $cp your_mt9v113_driver_directory/mt9v113.c            ./drivers/media/video
        $cp your_mt9v113_driver_directory/Makefile             ./drivers/media/video
        $cp your_mt9v113_driver_directory/Kconfig              ./drivers/media/video
        $cp your_mt9v113_driver_directory/mt9v113.h            ./include/media
    ...
    In menuconfig, enable the MT9V113 driver. The MT9V113 driver configuration is at the
    following location:
        "Device Drivers"-->"Multimedia support"-->"Video capture adapters"-->"Encoders/decoders and other helper chips" 

    Select "Aptina MT9V113(SOC380) VGA SOC sensor support"
	<*> Aptina MT9V113(SOC380) VGA SOC sensor support

    Note: other image sensors (such as the MT9V011 or MT9P015) should be de-selected.

    Enable/Disable MT9V113 driver compilation options that are located in the mt9v113.c file:
        MT9V113_DEBUG - Define this to enable debug printk support
    ...
    Copy the driver to the EXT3 partition if the mt9v113 driver is configured as a loadable module
        $cp drivers/media/video/mt9v113.ko  /media/Anstrom/home/root
...
MT9V113 SUPPORTED OUTPUT FRAME FORMATS
------------------------------
  UYVY
